...
async function main() {
  ...
  try {
    ...
    assert.match(response.body, />00:30:00<\/div>/);
    assert.match(response.body, />02:00:00<\/div>/);
    assert.match(response.body, />01:00:00<\/div>/);
    assert.match(response.body, />03:30:00<\/div>/);
